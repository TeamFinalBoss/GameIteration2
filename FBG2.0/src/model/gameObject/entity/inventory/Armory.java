...
/**
 * An Armory object is a component of an entity's inventory and holds its
 * equipped items.
 *
 * @author Matthew Kroeze
 * @version 1.0.0 2015-03-15
 */
public class Armory extends Observable {
    ...
    /* -------------------- MUTATORS -------------------- */
    /**
     * Equips the passed <code>Equipable</code> object. Is NOT responsible for
     * ensuring that the effects and stat changes of the equipment are applied.
     * Is NOT responsible for verifying that the equipee meets the requirements
     * of the equipment.
     *
    ...
    /**
     * Unequips and returns the equipment in the specified slot. Is NOT
     * responsible for undoing the stat changes of that equipment
     *
     * @param slot the <code>EquipSlot</code> of the <code>Equipable</code> item
     * to be unequipped
     * @return the <code>Equipable</code> item that was unequipped
     * @throws <code>IllegalArgumentException</code> if no equipment occupied
     * the specified slot
     */
